//
//  ConfirmDeskBookingRequestModel.swift
//  RSOWorkspace
//
...
import Foundation
 struct ConfirmDeskBookingRequestModel{
    var deskId: Int = 0
    var deskTypeId: String = ""
    var sittingConfig: [ConfigurationDetails] = []
    var deskprice:String = ""
    var location : String = ""
    var date: String = ""
    ...
    var floatPrice : Float {
        let price =  Float(self.deskprice) ?? 0.0
        return price
    }
...
//    mutating func setValues(model: StoreDeskBooking){
//        self.deskId = model.id
//        self.deskTypeId = model.deskTypeID
//        self.deskprice = model.totalPrice
